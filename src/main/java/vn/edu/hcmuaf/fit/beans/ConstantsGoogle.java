...
public class ConstantsGoogle {
    ...
    public static String GOOGLE_REDIRECT_URI = "http://petsshop.io.vn/LoginGoogleHandler";
//    public static String GOOGLE_REDIRECT_URI = "https://redirectmeto.com/http://34.143.250.88/LoginGoogleHandler";
