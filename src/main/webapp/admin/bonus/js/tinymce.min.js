...
!(function () {
  ...
  const Jo = ["pre"].concat(["h1", "h2", "h3", "h4", "h5", "h6"]),
    ...
    qr = Or,
    Wr = (e) =>
      !qr(e) && (jr(e) ? !Vr(e.parentNode) : Hr(e) || zr(e) || $r(e) || Kr(e)),
    Kr = (e) =>
  ...
  const os = (e, t = !0) =>
    ...
    ys = (e, t, n) => (
      (n = n || hs), e.replace(t ? ls : ds, (e) => fs[e] || n[e] || e)
    ),
    Cs = {
      encodeRaw: bs,
    ...
    Bs = (e) => {
      ...
      const s = {},
        ...
        i = (t, n, o) => {
          ...
          return (
            r
              ? (r = ks(r, /[, ]/, ks(r.toUpperCase(), /[, ]/)))
              : ((r = ws[t]), r || ((r = As(n, o)), (ws[t] = r))),
            r
          );
        },
      ...
      e.valid_elements
        ...
        : (Ss(d, (e, t) => {
          ...
          Ss(
            Rs("p h1 h2 h3 h4 h5 h6 th td pre div address caption li"),
            (e) => {
              n[e].paddEmpty = !0;
            }
          ),
  ...
  const Hs = Bt.each,
    ...
    Qs = (e, t = {}) => {
      ...
      const a = Xo.forElement(fn(e), {
        ...
        R = (e, n, o) => {
          const r = (e, t) =>
              m(e) ? e : x(e) ? (xe(Ys, t) ? e + "" : e + "px") : ge(e, r),
            s = (e, t, n) => {
              const o = Xs(t);
    ...
    sa = () => {
      const e = [],
        ...
        a = (e, n) => {
          ...
          !o ||
            (n && -1 === ("," + (n || "") + ",").indexOf("," + o + ",")) ||
            Zs.ScriptLoader.add(t[e] + "/langs/" + o + ".js");
        },
        i = (e, t = "added") =>
  ...
  const aa = () => {
    ...
    ba = (e, t) =>
      Yt(e, "data-mce-bogus") || ur(e, '[data-mce-bogus="all"]', pa(t)),
    va = (e, t) => {
  ...
  const wa = (e) => {
    ...
    Ta = (e, t) => {
      ...
      return (
        e.bottom - n < t.top ||
        (!(e.top > t.bottom) && Oa(t.top - e.bottom, e, t))
      );
    },
    Ba = (e, t) =>
      e.top > t.bottom || (!(e.bottom < t.top) && Oa(t.bottom - e.top, e, t)),
    Da = (e, t, n) => {
          ...
          (n = ((e) => {
            ...
            if (Fa(r))
              if (e.isAtEnd()) {
                ...
                const a = Ka(r, s);
                if (($a(a) && o(a, 0), Va(a) && e.isAtEnd()))
                  return n(ei(Za(a), !1)), t;
  ...
  (ti.fromRangeStart = (e) => ti(e.startContainer, e.startOffset)),
    ...
    (ti.isAbove = (e, t) =>
      Pt(ie(t.getClientRects()), le(e.getClientRects()), Ta).getOr(!1)),
    (ti.isBelow = (e, t) =>
      Pt(le(t.getClientRects()), ie(e.getClientRects()), Ba).getOr(!1)),
  ...
  const ni = (e, t) => {
    ...
    li = (e) =>
      e
        ? Oe(
            e.childNodes,
            (e, t) => (
              si(t) && "BR" !== t.nodeName ? (e = e.concat(li(t))) : e.push(t),
              e
            ),
            []
          )
      ...
      return s
        ? ri(s)
          ? ((e, t) => {
              ...
              return (
                ri(e) && t > e.data.length && (t = e.data.length), ti(e, t)
              );
            })(s, parseInt(n, 10))
    ...
    vi = (e, t) => {
      ...
      if (Or(e)) {
        if (
          (Ro(e) && Rr(e) && (e = e.parentNode), (n = e.previousSibling), fi(n))
        )
          return n;
    ...
    yi = (e, t, n) => {
      ...
      const a = ((e) =>
        vi(e.startContainer, e.startOffset) || vi(e.endContainer, e.endOffset))(
        s
      );
      return a
  ...
  const Ni = (e) => "inline-command" === e.type || "inline-format" === e.type,
    ...
    Ed = (e) => {
      yd(e) && Or(e) && (Tr(e) ? e.removeAttribute("data-mce-caret") : wd(e)),
        Cd(e) && (kd(e), 0 === e.data.length && wd(e));
    },
    Nd = Io,
    Rd = Uo,
    Ad = Fo,
  ...
  const lc = Io,
    ...
    fc = (e) =>
      ...
      ((e) =>
        !!Kr(e) &&
        !0 !== Y(de(e.getElementsByTagName("*")), (e, t) => e || Fr(t), !1))(e),
    gc = Gr,
    pc = (e, t) =>
    ...
    bc = (e, t, n) => {
      ...
      if (dc(i)) {
        ...
        if ($d(e) && l > 0 && ((r = pc(i, l - 1)), mc(r)))
          return !fc(r) && ((s = Wd(r, e, gc, r)), s)
            ? dc(s)
              ? ti(s, s.data.length)
              : ti.after(s)
            : dc(r)
      ...
      if (
        ((Hd(e) && a.isAtEnd()) || ($d(e) && a.isAtStart())) &&
        ((o = Wd(o, e, L, n, !0)), gc(o, n))
      )
        return hc(e, o);
      r = Wd(o, e, gc, n);
      const d = Be(
      ...
      return !d || (r && d.contains(r))
        ? r
          ? hc(e, r)
          : null
        : ((a = Hd(e) ? ti.after(d) : ti.before(d)), a);
    },
    vc = (e) => ({
    ...
    kc = (e, t, n) =>
      xc(e, t, n).bind((o) =>
        ...
        ((e, t, n) => {
          return e
            ? !wc(t, n) &&
                ((o = t), !(!ti.isTextPosition(o) && Po(o.getNode()))) &&
                Cc(t) &&
                yc(n)
            : !wc(n, t) && yc(t) && Cc(n);
          var o;
    ...
    Sc = (e, t, n, o) =>
      kc(e, t, n).bind((n) => (o(n) ? Sc(e, t, n, o) : M.some(n))),
    _c = (e, t) => {
      ...
      ((e, t) => {
        ...
        if (t) {
          if (Pc(t))
            return ((e, t) => {
              const n = e.createRng();
              return Uc(e, !0, t, n) && Uc(e, !1, t, n)
                ? M.some({ range: n, forward: Lc(t) })
                : M.none();
            })(n, t);
          if (((e) => m(e.start))(t))
            return M.some(
          ...
          if (((e) => xe(e, "id"))(t))
            return ((e, t) => {
              ...
              return Pt(n, o.or(n), (n, o) => {
                const r = e.createRng();
                return (
                  r.setStart(Mc(e, n.container()), n.offset()),
                  r.setEnd(Mc(e, o.container()), o.offset()),
                  { range: r, forward: Lc(t) }
                );
              });
            })(n, t);
          if (Dc(t))
          ...
          if (((e) => xe(e, "rng"))(t))
            return M.some({ range: t.rng, forward: Lc(t) });
        }
        return M.none();
  ...
  const Wc = (e) => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
    ...
    du = (e, t) => (
      ("color" !== t && "backgroundColor" !== t) || (e = eu(e)),
    ...
    _u = (e, t, n, o, r, s) => {
        ...
        l = (t, n, o) => {
          ...
          return M.from(
            l(
              t,
              n,
              (e, t) => (bu(e.parentNode) ? -1 : ((a = e), o(r, e, t))),
              i
            )
          );
        };
      return l(n, o, ku)
        .bind((e) =>
          s ? l(e.container, e.offset + (r ? -1 : 0), Su) : M.some(e)
        )
        .orThunk(() =>
    ...
    Nu = (e, t, n, o) => {
      ...
      if (
        (r && fu(i) && i.wrapper && (r = vu(s, r, "ul,ol").reverse()[0] || r),
        !r)
      )
    ...
    Ru = (e, t, n, o) => {
      ...
      return (
        !C(n[o]) && (!(r !== t && !y(r) && !e.isBlock(r)) || Ru(e, t, r, o))
      );
    },
    Au = (e, t, n, o, r) => {
      let s = n;
    ...
    Tu = (e, t, n, o = !1) => {
      ...
      return (
        ...
        (pu(d) || d.block_expand) &&
          ((pu(d) && Ro(r) && 0 !== s) || (r = Au(l, n, r, s, !0)),
          (pu(d) && Ro(a) && i !== a.nodeValue.length) ||
            (a = Au(l, n, a, i, !1))),
        hu(d) &&
          ((r = Eu(l, n, t, r, "previousSibling")),
          (a = Eu(l, n, t, a, "nextSibling"))),
        (fu(d) || gu(d)) &&
          ((r = Nu(e, n, r, "previousSibling")),
          (a = Nu(e, n, a, "nextSibling")),
          fu(d) &&
            (l.isBlock(r) || (r = Au(l, n, r, s, !0)),
  ...
  const Xu = (e, t, n) =>
    ...
    om = {
      ...
      HOME: 36,
      modifierPressed: (e) =>
        e.shiftKey || e.ctrlKey || e.altKey || om.metaKeyPressed(e),
      metaKeyPressed: (e) =>
        ...
        L = (o) => {
          ...
          if (
            ...
            if (P(t, a) && P(e.getEnd(!0), a))
              return n.setAttrib(a, rm, i), void B.throttle(a);
          }
          D();
        },
        M = () => {
    ...
    Bm = (e, t, n, o, r) => {
      ...
      for (; (i = c[o ? "prev" : "next"]()); ) {
        ...
        if (Ro(i) && i.nodeValue.length > 0)
          return !1 === Nm(i, a, "A")
            ? M.some(ti(i, o ? i.nodeValue.length : 0))
            : M.none();
  ...
  const Vm = (e) => "textarea" === Mt(e),
    ...
    df = (e) =>
      vm.range(
        e.start,
        lf(e.soffset, e.start),
        e.finish,
        lf(e.foffset, e.finish)
      ),
    ...
    pf = (e) =>
      (e.bookmark ? e.bookmark : M.none())
        .bind((t) => {
          return (
            (n = fn(e.getBody())), (o = t), M.from(o).filter(uf(n)).map(df)
          );
          var n, o;
        })
        .bind(ff),
  ...
  const yf = Qs.DOM,
    Cf = (e, t) => {
      const n = Dl(e),
        o = yf.getParent(
          t,
          (t) => ((e) => hf.isEditorUIElement(e))(t) || (!!n && e.dom.is(t, n))
        );
      return null !== o;
    },
    wf = (e, t) => {
    ...
    xf = (e, t) => {
      e.focusedEditor === t.editor && (e.focusedEditor = null),
        e.activeEditor || (yf.unbind(document, "focusin", vf), (vf = null));
    },
    kf = (e, t) => {
      ((e, t) =>
        ((e) =>
          e.collapsed
            ? M.from(La(e.startContainer, e.startOffset)).map(fn)
            : M.none())(t).bind((t) =>
  ...
  const Jf = ["font", "text-decoration", "text-emphasis"],
    ...
    rg = (e) => {
      ...
      return (
        Ro(t) &&
        (0 === t.data.length || (Sr(t.data) && Yu.isBookmarkNode(t.parentNode)))
      );
    },
    sg = (e, t) => (n) =>
      M.from(Yd(e ? 0 : -1, n))
    ...
    Gg = (e) => {
      return Wr(e.previousSibling)
        ? M.some(
            ((t = e.previousSibling),
            Ro(t) ? ti(t, t.data.length) : ti.after(t))
          )
        : e.previousSibling
        ? Ac(e.previousSibling)
        : M.none();
      var t;
    },
    Yg = (e) => {
      return Wr(e.nextSibling)
        ? M.some(((t = e.nextSibling), Ro(t) ? ti(t, 0) : ti.before(t)))
        : e.nextSibling
        ? Rc(e.nextSibling)
        : M.none();
      var t;
        ...
        e
          ? ((e, t) =>
              Yg(t)
                ...
                .orThunk(() =>
                  ((e, t) =>
                    Ec(e, ti.after(t)).fold(() => Nc(e, ti.before(t)), M.some))(
                    e,
                    t
                  )
                ))(t, n)
      ...
      const i = ((e, t, n) => {
        ...
        return (
          ...
          s.isSome() && a.isSome() && i.isSome()
            ...
            () => (
              n &&
                (o.each((e) => qg(e.dom, e.dom.length)),
                r.each((e) => $g(e.dom, 0))),
              t
            )
          )
    ...
    np = (e, t) => hn(fn(t), yl(e)),
    op = (e, t, n) => {
      const o = ((e, t, n) => K(Qs.DOM.getParents(n.container(), "*", t), e))(
        e,
        t,
        n
      );
    ...
    yp = (e, t) =>
      Mu(e.start, t).bind((n) => Mu(e.end, t).bind((e) => Lt(vn(n, e), n))),
    Cp = (e) => (t) =>
      yp(t, e).map((e) =>
        ((e, t, n) => ({ rng: e, table: t, cells: n }))(t, e, gp(e))
      ),
    wp = (e, t, n, o) => {
        ...
        const e = bp(n.startContainer, o),
          ...
          r = e
            .bind(
              (
                (e) => (t) =>
                  Mu(t, e).bind((e) => le(gp(e)).map((e) => pp(t, e)))
              )(o)
            )
            .bind(Cp(o)),
          s = t
            .bind(
              (
                (e) => (t) =>
                  Mu(t, e).bind((e) => ie(gp(e)).map((e) => pp(e, t)))
              )(o)
            )
            .bind(Cp(o));
    ...
    xp = (e, t) => J(e, (e) => vn(e, t)),
    kp = (e) =>
      Pt(xp(e.cells, e.rng.start), xp(e.cells, e.rng.end), (t, n) =>
        e.cells.slice(t, n + 1)
      ),
    Sp = (e, t) => {
      ...
      return Pp(o, n).fold(
        () =>
          ((e, t, n, o) => {
            ...
            return Dp(n, o).bind((o) =>
              os(o)
                ? Lp(e, o)
                : ((e, t, n, o, r) =>
                    kc(n, e.getBody(), r).bind((e) =>
                      Dp(t, fn(e.getNode())).bind((e) =>
            ...
            Lt(
              ((e, t) => {
                ...
                return (
                  Mp(t, n) || xc(t, e.getBody(), n).exists((e) => Mp(t, e))
                );
              })(e, t),
              S
            )
              ...
              : ((e, t, n, o) =>
                  Pp(t, o).fold(
                    () =>
                      ((e, t, n) =>
                        _p(t, n).bind((t) =>
                          t.fold(O(Tp, e), O(Bp, e), O(Ap, e), O(Op, e))
                        ))(e, t, n),
                    (t) => ((e, t) => Lp(e, t))(e, t)
                  ))(e, o, r, t);
          })(e, n, o);
    ...
    $p = (e, t, n, o) => {
      t.insert && n[o.name]
        ? o.empty().append(new jf("br", 1))
        : (o.empty().append(new jf("#text", 3)).value = fr);
    },
    qp = (e, t) =>
      e &&
      e.firstChild &&
    ...
    eh = (e, t, n, o) => {
      ...
      return d(1)
        ...
        : d(2)
        ? ((e, t, n, o) => (o.insertAfter(t.reverse(), e), Zp(t[0], n)))(
            s,
            a,
            l,
            t
    ...
    oh = (e, t, n) => {
      ...
      f === g &&
        ...
        i.isCollapsed() ||
          ((e) => {
            ...
            ((e, t, n) =>
              null !== n &&
              n === e.getParent(t.endContainer, nh) &&
              Uu(fn(n), t))(t, n, o)
              ? Tp(e, n, fn(o))
      ...
      if (!0 === n.paste && Xp(e.schema, h) && ((e, t) => !!Jp(e, t))(l, r))
        return (s = eh(u, l, i.getRng(), h)), i.setRng(s), t;
      if (
        (!0 === n.paste &&
          ((e, t, n, o) => {
            var r;
        ...
        for (a = a.prev; a; a = a.walk(!0))
          if (3 === a.type || !l.isBlock(a.name)) {
            e.schema.isValidChild(a.parent.name, "span") &&
              a.parent.insert(t, a, "br" === a.name);
            break;
          }
      }
          ...
          if (t) {
            ...
            Bt.each(o.select("*[data-mce-fragment]"), (e) => {
              if (
                ...
                ((e, t) => te(Zf(e, t), (e) => !((e) => Qf.has(e))(e)))(o, e)
              )
                for (
                  let n = e.parentNode;
                  C(n) && n !== t && !eg(o, e, n);
    ...
    uh = (e, t, n, o, r) => {
      ...
      return (
        ...
        ((t = e.dom.getParent(
          t,
          (t) => !!ch(e, t, n) || t.parentNode === s || !!gh(e, t, n, o, !0)
        )),
        !!gh(e, t, n, o, r))
      );
    },
  ...
  const Oh = Bt.each,
    ...
    Kh = (e, t, n, o, r) => {
      ...
      if ("all" !== t.remove) {
        zh(t.styles, (e, o) => {
          (e = du(iu(e, n), o + "")),
            x(o) && ((o = e), (r = null)),
            (t.remove_similar || !r || jh(cu(a, r, o), e)) &&
              a.setStyle(i, o, ""),
            (s = !0);
        }),
          s &&
          ...
          zh(t.attributes, (e, o) => {
            ...
            if (
              ...
              if (
                (Uh.test(o) && i.removeAttribute("data-mce-" + o),
                "style" === o &&
                  wo(["li"])(i) &&
        ...
        ? (((e, t, n) => {
            ...
            fu(n) &&
              ...
              ((n.list_block && jh(t, n.list_block)) ||
                $(de(t.childNodes), (t) => {
                  su(e, a, t.nodeName.toLowerCase())
                    ? r
                      ? r.appendChild(t)
                      : ((r = qh(s, t, a)), s.setAttribs(r, Gi(e)))
                    : (r = null);
                })),
              (((e) => gu(e) && pu(e) && Dt(we(e, "mixed"), !0))(n) &&
                !jh(n.inline, t)) ||
                s.remove(t, !0);
          })(e, i, t),
          Fh.removed())
    ...
    Gh = (e, t, n, o, r) =>
      Kh(e, t, n, o, r).fold(P, (t) => (e.dom.rename(o, t), !0), L),
    Yh = (e, t, n, o) =>
      Kh(e, t, n, o, o).fold(
        N(o),
    ...
    Xh = (e, t, n, o, r) => {
      ...
      const l = e.dom,
          ...
          return ((e, t, n, o, r, s, a, i) => {
            ...
            if (n) {
              ...
              for (let n = o.parentNode; n && n !== s; n = n.parentNode) {
                ...
                for (
                  let n = 0;
                  n < t.length && ((l = Yh(e, t[n], i, l)), null !== l);
                  n++
                );
        ...
        f = (e) => {
          ...
          return (
            ((e) => $c(e) && Co(e) && ("_start" === e.id || "_end" === e.id))(
              n
      ...
      if (o) {
        ...
        for (
          let t = 0;
          t < s.length && (!s[t].ceFalseOverride || !Gh(e, s[t], n, o, o));
          t++
        );
        Zu(e, t, o, n);
      }
                ...
                ? (pu(s) || (fu(s) && s.wrapper)) &&
                  ...
                  ((e, t, n, o) => {
                    !pu(t) ||
                      ...
                      (Lh(o, Mh(e, "fontSize"), Ih(e, "fontSize", "")),
                      e.remove(
  ...
  var Fb = bb([
    ...
    sv = (function e() {
      var t =
          arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : ov(),
        n = function (t) {
          return e(t);
        };
      if (
      ...
      var T,
        ...
        ke = function (e) {
          (Ce && Ce === e) ||
            ...
            (ue =
              "ADD_URI_SAFE_ATTR" in e ? Lb(Mb(me), e.ADD_URI_SAFE_ATTR) : me),
            (de =
              "ADD_DATA_URI_TAGS" in e ? Lb(Mb(ce), e.ADD_DATA_URI_TAGS) : ce),
            ...
            e.FORBID_CONTENTS &&
              (ie === le && (ie = Mb(ie)), Lb(ie, e.FORBID_CONTENTS)),
            re && (z["#text"] = !0),
        ...
        Ie = function (e) {
          ...
          return e instanceof l && !Ae(e)
            ...
            : ("noscript" !== o && "noembed" !== o) ||
              !Bb(/<\/no(script|embed)/i, e.innerHTML)
            ? (X &&
                3 === e.nodeType &&
                ((t = e.textContent),
                (t = Ab(t, D, " ")),
                (t = Ab(t, P, " ")),
                e.textContent !== t &&
                  (Eb(n.removed, { element: e.cloneNode() }),
                  (e.textContent = t))),
        ...
        (n.sanitize = function (e, r) {
          ...
          return (
            Q &&
              ...
              Bb(nv, a.ownerDocument.doctype.name) &&
    ...
    constructor(e, t) {
      ...
      if (
        ...
        const t = this.settings.base_uri
          ...
          : new xv(document.location.href).directory;
  ...
  const kv = Bt.makeMap,
        ...
        n.addHook("uponSanitizeElement", (n, a) => {
          ...
          if (!r || p) {
            if (((a.allowedTags[d] = !0), r && !f)) {
              if (
                ($(
                  null !== (i = p.attributesForced) && void 0 !== i ? i : [],
                  (e) => {
                    qt(
                      c,
                      e.name,
                ...
                $(
                  null !== (l = p.attributesDefault) && void 0 !== l ? l : [],
                  (e) => {
                    Yt(c, e.name) ||
                      qt(
                        c,
                ...
                p.attributesRequired &&
                  !V(p.attributesRequired, (e) => Yt(c, e)))
              )
                return void oo(c);
              if (
                p.removeEmptyAttrs &&
          ...
          parse: (e, n = {}) => {
            ...
            const [f, g] = ((e, t, n, o) => {
                const r = n.validate,
                  ...
                  i = Sv(
                    kv("script,style,head,html,body,title,meta,param"),
                    t.getBlockElements()
                  ),
                  l = Os(t),
                  d = /[ \t\r\n]+/g,
                      ...
                      if (r && n) {
                        ...
                        ((e) => {
                          ...
                          : n.paddEmpty &&
                            (r ||
                              ((e) =>
                                qp(e, "#text") && e.firstChild.value === fr)(
                                e
                              )) &&
                            $p(0, o, i, e);
                      }
    ...
    Tv = (e, t) => {
      ...
      if (rh(e)) {
        if (o.content !== n) {
          const t = Ov({ validate: !1, forced_root_block: !1 }).parse(
            o.content,
            { context: e.name }
          );
          return { ...o, content: t };
    ...
    Bv = (e, t) => {
      if (t.no_events) return _i.value(t);
      {
        ...
        return n.isDefaultPrevented()
          ? _i.error(tm(e, { content: "", ...n }).content)
          : _i.value(n);
      }
    },
    Dv = (e, t, n) =>
      n.no_events ? t : Tv(t, (t) => tm(e, { ...n, content: t })).content,
    Pv = (e, t) => {
      if (t.no_events) return _i.value(t);
      {
        const n = Tv(t.content, (n) =>
          ((e, t) => e.dispatch("BeforeSetContent", t))(e, { ...t, content: n })
        );
        return n.isDefaultPrevented()
          ? (em(e, n), _i.error(void 0))
          : _i.value(n);
      }
    },
    Lv = (e, t, n) => {
    ...
    ey = (e) => {
      const t =
        ((n = e.getBody()), K(H(de(n.childNodes), Qv), (e) => e.length > 0));
      var n;
      const o = ee(t, (t) => {
    ...
    ly = (e) => ({
      ...
      undoManager: {
        ...
        add: (t, n, o, r, s, a) =>
          ((e, t, n, o, r, s, a) => {
            const i = ey(e);
            if (
              ((s = s || {}), (s = Bt.extend(s, i)), !1 === sy(o) || e.removed)
            )
              return null;
        ...
        hasUndo: (t, n) =>
          ((e, t, n) =>
            n.get() > 0 || (t.typing && t.data[0] && !ry(ey(e), t.data[0])))(
            e,
            t,
            n
          ),
        ...
        transact: (e, t, n) =>
          ((e, t, n) => (iy(e, t), e.beforeChange(), e.ignore(n), e.add()))(
            e,
            t,
            n
          ),
      ...
      formatter: {
            ...
            return M.from(e.selection.getStart(!0))
              .bind((o) =>
                lh(
                  ...
                  (n) =>
                    ce(t, (t) =>
                      ((t, n) => (gh(e, t.dom, n) ? M.some(n) : M.none()))(n, t)
                    ),
                  n
                )
              )
        ...
        toggle: (t, n, o) =>
          ((e, t, n, o) => {
            const r = e.formatter.get(t);
            !ph(e, t, n, o) || ("toggle" in r[0] && !r[0].toggle)
              ? eb(e, t, n, o)
              : Xh(e, t, n, o);
          })(e, t, n, o),
        ...
        getContent: (t) =>
          ((e, t) =>
            M.from(e.getBody()).fold(
              N("tree" === t.format ? new jf("body", 11) : ""),
              (n) =>
                ((e, t, n) => {
                  let o;
                  return (
              ...
              .map((o) =>
                rh(t)
                  ...
                  : ((e, t, n, o) => {
                      if (0 === n.length || /^\s+$/.test(n)) {
                        ...
                        return (
                          e.schema.isValidChild(
                            ...
                            ? ((n = r), (n = e.dom.createHTML(s, Gi(e), n)))
                            : n || (n = r),
                      ...
                      {
                        "raw" !== o.format &&
                          (n = Xf({ validate: !1 }, e.schema).serialize(
                            e.parser.parse(n, { isRootContent: !0, insert: !0 })
                          ));
                        const r = lr(fn(t)) ? n : Bt.trim(n);
                        return (
                          sh(e, r, o.no_selection), { content: r, html: r }
                        );
                      }
                    })(e, o, t, n)
              )
              .getOr({ content: t, html: rh(n.content) ? "" : n.content }))(
            e,
            t,
            n
          ),
                    ...
                    M.from(e.selection.getRng())
                      .map((t) => {
                        const n = M.from(
                          ...
                          i = _r(s.textContent);
                        if (
                          (e.dom.remove(s), Yv(i, 0) || Yv(i, i.length - 1))
                        ) {
                          const e = n.getOr(o),
                            t = Xv(e),
                            r = t.indexOf(a);
        ...
        (e) => (
          ...
          t.filter(zt).map((t) =>
            ((e, t, n, o) => {
              ...
              o
                ? (Wg(r, s, !1, !o), n.setStart(s, a))
                : (Wg(s, r, !1, !o), n.setEnd(s, a));
            })(e, t, n, o)
          )
        )
      ).orThunk(() => {
        const e = ((e, t) =>
          e.filter((e) => Yu.isBookmarkNode(e.dom)).bind(t ? _n : Sn))(t, o)
          .or(t)
          .filter(zt);
        return e.map((e) =>
          ((e, t) => {
            kn(e).each((n) => {
              ...
              t && Ig(n, ti(o, 0))
                ? $g(o, 0)
                : !t && Fg(n, ti(o, o.length)) && qg(o, o.length);
            });
          })(e, o)
        );
      });
        ...
        f = {
          ...
          setCursorLocation: (t, n) => {
            ...
            C(t) && C(n)
              ...
              : (zu(e, r, o.getBody(), !0), u(r));
          },
          getContent: (e) =>
            ((e, t = {}) =>
              ((e, t, n) => uy(e).selection.getContent(t, n))(
                e,
          ...
          getNode: () =>
            ((e, t) => {
              ...
              return (
                ...
                3 === o.nodeType &&
                  3 === r.nodeType &&
                  ((o = o.length === s ? Of(o.nextSibling, !0) : o.parentNode),
          ...
          getSelectedBlocks: (t, n) =>
            ((e, t, n, o) => {
              ...
              const s = [],
                a = e.getRoot();
              if (
                ((n = e.getParent(n || Rf(a, t, t.collapsed), e.isBlock)),
    ...
    wy = (e, t, n = {}) => {
      ...
      return Pv(e, o)
        .map((t) => {
          const n = ((e, t, n) => cy(e).editor.setContent(t, n))(
            e,
            t.content,
            t
          );
                    ...
                    return C(s)
                      ...
                      : ((o = t),
                        ze(o, "blob:")
                          ...
                          uv(t).then((o) =>
                            fv(o, !1, (n) => M.some(gv(e, t, n))).getOrThunk(n)
                          )
                        );
                  }
                  var o, r;
                  return ze(t, "data:")
                    ? pv(e, t).fold(n, (e) => Promise.resolve(e))
  ...
  const Xy = (e, t) => {
                      ...
                      n.status && nl(e)
                        ...
                        : n.error &&
                          ...
                          ((e, t) => {
                            jy(
                              e,
                              ra.translate(["Failed to upload image: {0}", t])
                            );
                          })(e, n.error.message)),
                      {
                        element: l,
    ...
    lC = (e, t) => {
      ...
      var d;
      l.length
        ? (l[0].name || (l[0].name = n), (n = t.selector), (o = aC(l, e)))
        : (o = aC([n], e));
          ...
          if (
            !(
              ("background-color" === t &&
                ...
                ((n = sC.getStyle(e.getBody(), t, !0)),
                "#ffffff" === eu(n).toLowerCase())) ||
              ("color" === t && "#000000" === eu(n).toLowerCase())
            )
          ) {
    ...
    dC = (e) => {
      ...
      return (
          ...
          e.on("mouseup keydown", (t) => {
            ((e, t) => {
              ...
              xh(e, null, !1),
                (8 !== t && 46 !== t) ||
                  !n.isCollapsed() ||
                  n.getStart().innerHTML !== hh ||
                  xh(e, Bc(o, n.getStart())),
        ...
        })(e),
        {
          ...
          match: (t, n, o, r) =>
            ((e, t, n, o, r) => uy(e).formatter.match(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          matchAll: (t, n) =>
            ((e, t, n) => uy(e).formatter.matchAll(t, n))(e, t, n),
          matchNode: (t, n, o, r) =>
            ((e, t, n, o, r) => uy(e).formatter.matchNode(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          formatChanged: (t, o, r, s) =>
            ((e, t, n, o, r, s) =>
              uy(e).formatter.formatChanged(t, n, o, r, s))(e, n, t, o, r, s),
          getCssText: O(lC, e),
        }
      );
    },
    ...
    uC = (e) => {
      const t = aa(),
        ...
        r = {
          ...
          add: (s, a) =>
            ((e, t, n, o, r, s, a) => uy(e).undoManager.add(t, n, o, r, s, a))(
              e,
              r,
              o,
              n,
          ...
          undo: () =>
            ((e, t, n, o) => uy(e).undoManager.undo(t, n, o))(e, r, n, o),
          ...
          hasUndo: () =>
            ((e, t, n) => uy(e).undoManager.hasUndo(t, n))(e, r, o),
          hasRedo: () =>
            ((e, t, n) => uy(e).undoManager.hasRedo(t, n))(e, r, o),
          transact: (t) =>
            ((e, t, n, o) => uy(e).undoManager.transact(t, n, o))(e, r, n, t),
          ignore: (t) => {
            ((e, t, n) => {
    ...
    RC = (e) => {
      ...
      return ((e, t) => {
        ...
        return (
          !((e, t) => NC(e, t.startContainer) || NC(e, t.endContainer))(e, t) &&
          n &&
          o
        );
        ...
        : ((e, t) => {
            const n = t.getRng();
            return Pt(
              cp(e, fn(n.startContainer)),
              cp(e, fn(n.endContainer)),
              (o, r) =>
                !1 === vn(o, r)
                  ? M.some(() => {
                      n.deleteContents(),
    ...
    zC = (e) => {
      ...
      return (
        !t.collapsed &&
        (UC(e, !0).exists((e) => e.isEqual(ti.fromRangeStart(t))) ||
          UC(e, !1).exists((e) => e.isEqual(ti.fromRangeEnd(t))))
      );
    },
    jC = Ei([
      { remove: ["element"] },
          ...
          () =>
            ((e, t, n) => {
              ...
              return !1 === t && pg(r)
                ...
                : ((e, t, n) =>
                    ((e, t) => {
                      ...
                      ? ((e, t) =>
                          e && Io(t.nextSibling)
                            ? M.some(jC.moveToElement(t.nextSibling))
                            : !1 === e && Io(t.previousSibling)
                            ? M.some(jC.moveToElement(t.previousSibling))
              ...
              (n) => () =>
                n.fold(
                  ((e, t) => (n) => (
                    e._selectionOverrides.hideFakeCaret(), ep(e, t, fn(n)), !0
                  ))(e, t),
                  ((e, t) => (n) => {
      ...
      e
        ? ((e) => {
            if (GC(e.previousSibling))
              return (
                XC(e.previousSibling) || e.previousSibling.appendData(kr),
                e.previousSibling
              );
        ...
        : ((e) => {
            if (GC(e.nextSibling))
              return (
                YC(e.nextSibling) || e.nextSibling.insertData(0, kr),
                e.nextSibling
              );
    ...
    ew = O(JC, !1),
    tw = (e, t) =>
      Ro(e.container()) ? JC(t, e.container()) : JC(t, e.getNode()),
    nw = (e, t) => {
      const n = t.get();
    ...
    cw = (e, t, n) => {
      const o = ap(n);
      return dw(e, t, o).bind((e) =>
        Nc(e, o).isNone() ? M.some(sw.start(e)) : M.none()
      );
    },
    uw = (e, t, n) => {
      const o = sp(n);
      return dw(e, t, o).bind((e) =>
        Ec(e, o).isNone() ? M.some(sw.end(e)) : M.none()
      );
    },
    mw = (e, t, n) => {
      const o = ap(n),
    ...
    fw = (e) => {
      return (
        !1 ===
        ((t = pw(e)),
        "rtl" === Qs.DOM.getStyle(t, "direction", !0) ||
          ((e) => tp.test(e))(t.textContent))
      );
      var t;
    },
    ...
    ww = (e, t) =>
      e
        ? t.fold(_(M.some, sw.start), M.none, _(M.some, sw.after), M.none)
        : t.fold(M.none, _(M.some, sw.before), M.none, _(M.some, sw.end)),
    xw = (e, t, n) => {
      const o = e ? 1 : -1;
      return (
  ...
  const $w = (e, t, n, o, r, s) => {
    ...
    Jw = (e, t, n, o, r, s) => {
      ...
      if (((g = o(a) ? a.getNode() : r(a) ? a.getNode(!0) : Pa(n)), g)) {
        const n = ((e, t, n, o) => {
          ...
          1 === e
            ? ((s = r.next), (a = Ba), (i = Ta), (l = ti.after(o)))
            : ((s = r.prev), (a = Ta), (i = Ba), (l = ti.before(o)));
          const m = u(l);
          do {
      ...
      return (
        e.on("NodeChange", (o) => {
          Al(e) &&
            (((e, t, n) => {
              const o = H(
                  hr(fn(t.getRoot()), '*[data-mce-selected="inline-boundary"]'),
                  (e) => e.dom
                ),
                r = K(o, e),
                s = K(n, e);
    ...
    mx = (e, t, n, o) => {
      ...
      e.undoManager.ignore(() => {
        e.selection.setRng(
          ...
          lp(e),
          gw(s, r, ti.fromRangeStart(e.selection.getRng()))
            .map(vw)
            .bind(ux(e, t))
            .each(D);
      }),
      ...
      if (e.selection.isCollapsed() && Al(e)) {
        ...
        return ((e, t, n, o) => {
          ...
          return a
            .bind((e) =>
              n
                ? e.fold(N(M.some(vw(e))), M.none, N(M.some(bw(e))), M.none)
                : e.fold(M.none, N(M.some(bw(e))), M.none, N(M.some(vw(e))))
            )
            .map(ux(e, t))
            .getOrThunk(() => {
              const i = kc(n, r, o),
        ...
        return !((e, t, n) =>
          Pt(Rc(n), Ac(n), (o, r) => {
            const s = rp(!0, o),
              ...
              i = rp(!1, t);
            return e
              ? Ec(n, i).exists((e) => e.isEqual(a) && t.isEqual(s))
              : Nc(n, i).exists((e) => e.isEqual(s) && t.isEqual(a));
          }).getOr(!0))(t, o, n.dom) ||
          (Tc((s = n).dom) && vh(s.dom))
          ? M.none()
          : M.some(() =>
    ...
    Nx = (e, t, n) =>
      ce([Ex, WC, FC, (e, n) => fx(e, t, n), EC, Fp, KC, vx, AC, hx], (t) =>
        t(e, n)
      ),
    Rx = (e, t) => {
      e.addCommand("delete", () => {
    ...
    Bx = (e, t) => {
      if (Ro(t)) {
        ...
        if (
          /^\s+$/.test(t.nodeValue) &&
          (!t.nextSibling || Ox(e, t.nextSibling))
        )
          return !0;
      }
      return !1;
    ...
    Px = (e) => {
      ...
      if (
        ...
        ((e, t, n) => V(hg(fn(n), fn(t)), (t) => Ox(e, t.dom)))(r, a, s)
      )
        return;
      const m = n.getRng(),
        f = m.startContainer,
      ...
      for (s = a.firstChild; s; )
        if (Tx(r, s)) {
          ...
          i || ((i = Dx(e)), s.parentNode.insertBefore(i, s), (d = !0)),
            (l = s),
            (s = s.nextSibling),
            i.appendChild(l);
    ...
    Ux = (e, t) => {
      ...
      if (n)
        return "compositionstart" === t.type
          ? (t.preventDefault(), t.stopPropagation(), void Fx(e, n))
    ...
    Vx = (e, t) =>
      ((e, t) => {
        const n = t ? ic.Forwards : ic.Backwards,
          o = e.selection.getRng();
        return ((e, t, n) => Qw(t, e, n, gg, pg, zx))(n, e, o).orThunk(
          () => (jx(e, n, o), M.none())
        );
    ...
    Kx = (e, t) => {
      ...
      return ((e, t) => {
        ...
        if (
          ((e, t, n) =>
            t
              ? ((e, t) => Bw(e, t).breakAt.isNone())(e.dom, n)
              : ((e, t) => Tw(e, t).breakAt.isNone())(e.dom, n))(n, t, o)
        ) {
    ...
    sk = (e, t, n) =>
      ee(Rn(e), (e) => (hn(e, t) ? (n(e) ? [e] : []) : sk(e, t, n))),
    ak = (e, t) => Go(e, "table", t),
    ik = (e, t, n, o, r = L) => {
      const s = 1 === o;
    ...
    gk = (e, t, n) => {
      const o = e(t, n);
      return ((e) => e.breakType === kw.Wrap && 0 === e.positions.length)(o) ||
        (!Po(n.getNode()) &&
          ((e) => e.breakType === kw.Br && 1 === e.positions.length)(o))
      ...
      if (t && hk(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            ...
            .orThunk(() =>
              ie(n.getClientRects()).bind((n) => Aw(Pw(e, ti.after(t)), n.left))
            )
    ...
    Ok = (e, t, n) => {
      ...
      {
        const o = Ea(Rk);
        return M.from(o.backwards(e, t, Ak(e), n)).map((e) =>
          Nk(e.container, e.container.data.length)
        );
      }
    },
    Tk = (e, t, n) => {
    ...
    Bk = (e, t, n) => {
      ...
      {
        const r = Ea(Rk);
        return M.from(r.forwards(e, t, Ak(e), n)).bind((e) =>
          Bk(e.container, t - o.length, n)
        );
      }
    },
    Dk = (e, t, n, o, r) => {
          ...
          ((e, t, n, o = 0) => {
            ...
            return Dk(
              ...
              if (
                ...
                return M.none();
              const s = Pk(r);
              return 0 !== s.lastIndexOf(n) || Mk(s, n).length < o
                ? M.none()
                : M.some({ text: Mk(s, n), range: r, triggerChar: n });
            });
          })(e, t, n, o),
        (t) => {
          const o = e.createRng();
  ...
  const Vk = (e, t, n) => (e.stype === jk.Error ? t(e.serror) : n(e.svalue)),
    ...
    FS = rS([
      ...
      bS("ch"),
      xS("minChars", 1),
      (1, ((e, t) => gS(e, e, Qk(1), lS()))("columns")),
      xS("maxResults", 10),
      ("matches", yS("matches", fS)),
      NS,
      RS,
      ((US = uS), wS("highlightOn", [], sS(US))),
    ]);
  var US;
  ...
  rS(
    [
      ...
      _S("initValue", N("")),
      DS,
      ((e, t) => gS(e, e, { tag: "required", process: {} }, sS(t)))(
        "commands",
        KS
      ),
      yS(
        "launch",
        iS("type", { contextformbutton: qS, contextformtogglebutton: WS })
      ),
    ].concat(VS)
  );
  const GS = (e) => {
        ...
        a = (a) => {
          ((n) =>
            t
              .get()
              .map((t) =>
                Ik(e.dom, e.selection.getRng(), t.triggerChar).bind((t) =>
                  zk(e, s, t, n)
                )
              )
              .getOrThunk(() =>
                ((e, t) => {
                  const n = t(),
                    o = e.selection.getRng();
                  return ((e, t, n) => ce(n.triggerChars, (n) => Ik(e, t, n)))(
                    e.dom,
                    o,
                    n
                  ).bind((n) => zk(e, t, n));
              ...
              (Rr(s)
                ...
                : ((n = ((e) => {
                    ...
                    return (
                      ...
                      t.setEnd(
                        e.endContainer,
                        d_(!1, e.endContainer, e.endOffset)
                      ),
                      t
                    );
                  })(p).cloneRange()),
    ...
    B_ = (e, t, n) => {
      t.selection.isCollapsed() || lp(t),
        (C(n) && JS(t, e.fakeEventName).isDefaultPrevented()) ||
          (e.insert(t, n), C(n) && QS(t, e.fakeEventName));
    },
    D_ = (e, t) => {
      const n = () => B_(C_, e, t),
        o = () => B_(m_, e, t),
    ...
    I_ = (e, t, n) => {
      n && !e.get()
        ? t.on("NodeChange", L_, !0)
        : !n && e.get() && t.off("NodeChange", L_),
        e.set(n);
    },
    F_ = (e, t) => {
      const n = t.container(),
    ...
    H_ = (e) =>
      vd(e)
        ...
        : [],
    $_ = (e) => {
      if ((e.addShortcut("Meta+P", "", "mcePrint"), YS(e), dy(e)))
        return ea(null);
      {
        const t = ix(e);
        return (
              ...
              !1 === n.isDefaultPrevented() &&
                ((e, t, n) => {
                  ...
                  Zx(
                    ...
                    n.preventDefault(),
                      JS(e, o).isDefaultPrevented() || (t(), QS(e, o));
                  });
                })(e, t, n);
            }),
              e.on("keyup", (t) => {
          ...
          ((e) => {
            e.on("keydown", (t) => {
              !1 === t.isDefaultPrevented() &&
                ((e, t) => {
                  Zx([{ keyCode: om.SPACEBAR, action: Qx(V_, e) }], t).each(
                    (n) => {
                      t.preventDefault(),
                        JS(e, "insertText", {
                          data: " ",
                        }).isDefaultPrevented() ||
                          (n(), QS(e, "insertText", { data: " " }));
                    }
                  );
                })(e, t);
            });
  ...
  const W_ = N("x-tinymce/html"),
    ...
    aE = (e, t, n) =>
      !!((e, t) =>
        rE(t) && V(bd(e), (e) => je(t.toLowerCase(), `.${e.toLowerCase()}`)))(
        e,
        t
      ) &&
      ((e, t, n) => (
      ...
      if (od(e) && o) {
        ...
        if (s.length > 0)
          return (
            ...
            ((r = s),
            Promise.all(
              H(r, (e) => uv(e).then((t) => ({ file: e, uri: t })))
            )).then((t) => {
    ...
    hE = (e, t, n) => {
      ((e, t, n) => {
        ...
        e.on("keydown", (e) => {
          ((e) =>
            (om.metaKeyPressed(e) && 86 === e.keyCode) ||
    ...
    yE = (e) => ({
      html: G_(e.selection.getContent({ contextual: !0 })),
    ...
    wE = (e, t) => {
      var n, o;
      return Im.getCaretRangeFromPoint(
    ...
    DE = (e) => {
      const t = ((e, t) => {
        const n = ti.fromRangeStart(e).getNode(),
          o = ((e, t) =>
            qo(fn(e), (e) => ((e) => Mo(e.dom))(e) || er(e), OE(t)).getOr(fn(t))
              .dom)(n, t),
          r = BE(n, o, !1),
          s = BE(n, o, !0),
  ...
  const LE = (e, t) => Math.abs(e.left - t),
                ...
                if (e.dragging) {
                  const r = ((e, t) => ({
                    ...
                    ((e, t) => {
                      return (
                        (n = ((e) =>
                          e.inline ? jE(e.getBody()) : { left: 0, top: 0 })(e)),
                        (o = ((e) => {
                          const t = e.getBody();
                          return e.inline
          ...
          e.on(
            ...
            (t) => {
              const n = t.target,
                o = YE(e, n);
              GE(o)
                ? (t.preventDefault(), DC(e, o).each(g))
                : d(n) && DC(e, n).each(g);
            },
            !0
          ),
          e.on("mousedown", (o) => {
            ...
            GE(a)
              ...
              : zE(r, o.clientX, o.clientY).each((n) => {
                  var r;
                  o.preventDefault(),
                    (r = c(1, n.node, n.position === PE.Before, !1)) &&
                      t.setRng(r),
                  ...
                  const t = (t) => {
                      if (!t.isDefaultPrevented()) {
                        ...
                        n &&
                          ...
                          (t.preventDefault(),
                          "drop" === t.type &&
                            jy(e, "Dropped file type is not supported"));
                      }
                    },
                    n = (n) => {
                      Cf(e, n.target) && t(n);
              ...
              e.on("focusin", (t) => {
                ...
                if (Uo(n)) {
                  ...
                  e.selection.getNode() !== o &&
                    DC(e, o).each((t) => e.selection.setRng(t));
                }
              });
            });
          })(e)),
    ...
    rN = (e, t, n) => {
      ((e, t, n) => {
        ...
        {
          const t = Ea(Rk);
          return M.from(t.forwards(e, 0, Ak(e), n)).map((e) =>
            Nk(e.container, 0)
          );
        }
      })(t, 0, t).each((o) => {
            ...
            .bind((e) => {
              ...
              return r.map((t) =>
                Bt.trim(o).length === t.start.length
                  ? []
                  : [{ pattern: t, range: JE(n.getRoot(), e, 0, e, 0) }]
              );
            })
            .getOr([]);
        })(e, t.blockPatterns);
      ...
      e.on(
        ...
        (t) => {
          ...
          13 !== t.keyCode ||
            ...
            (hN(
              e,
              ((n = fd(e)), { inlinePatterns: Ti(n), blockPatterns: Oi(n) })
            ) &&
              t.preventDefault());
        },
        !0
        ...
        e.on("keyup", (t) => {
          vN(n, t, (e, t) => e === t.keyCode && !1 === om.modifierPressed(t)) &&
            bN(e, o());
        }),
        e.on("keypress", (n) => {
    ...
    RN = (e) => {
      !0 !== e.removed &&
        (((e) => {
          dy(e) || e.load({ initial: !0, format: "html" }),
    ...
    AN = (e) => {
      ...
      let n = e.getDoc();
      e.inline &&
        (wN.addClass(t, "mce-content-body"),
      ...
      (o.disabled = !0),
        ...
        e.readonly ||
          (e.inline &&
            "static" === wN.getStyle(o, "position", !0) &&
            ...
            r = (s, a) => {
              ...
              const i = e.getBody(),
                l =
                  !((e) =>
                    gC(e) &&
                    !(pC(e) || ("keyup" === e.type && 229 === e.keyCode)))(s) &&
                  ((e, t, n) => {
                    if (os(fn(t), !1)) {
      ...
      ((e) => {
        ...
        ((e) => {
          ...
          ed(e) ||
            ((t.body.spellcheck = !1), wN.setAttrib(n, "spellcheck", "false")),
          (e.quirks = CN(e)),
          ((e) => {
          ...
          if (m(t)) {
            ...
            (e.theme = n(e, Fy.urls[t]) || {}),
              w(e.theme.init) &&
                e.theme.init(
                  e,
                  Fy.urls[t] || e.documentBaseUrl.replace(/\/$/, "")
                );
          } else e.theme = {};
        })(e),
        ((e) => {
              ...
              if (((n = Bt.trim(n)), o && -1 === Bt.inArray(t, n))) {
                ...
                try {
                  ...
                  ((e, t, n) => {
                    ...
                    Qu(e, "PluginLoadError", { message: o }),
                      $y(o, n),
                      jy(e, o);
                  })(e, n, t);
                }
        ...
        e.inline
          ...
          : ((e, t) => {
              ((e, t) => {
                ...
                t.editorContainer &&
                  ((TN.get(t.editorContainer).style.display = e.orgDisplay),
    ...
    GN = (e, t, n, o, r) => {
      ...
      return ((e, t, n, o) => {
        const r = HN(n.forced_plugins),
          ...
          i = ((e, t, n, o) => (e && qN(t, "mobile") ? o : n))(
            e,
            t,
            s,
            a.plugins ? HN(a.plugins) : s
          ),
    ...
    XN = (e, t) => {
      ...
      return /^ | $/.test(t)
        ? ((e, t, n) => {
            ...
            return (
              (n = Ig(o, ti.fromRangeStart(t))
                ? n.replace(/^ /, "&nbsp;")
                : n.replace(/^&nbsp;/, " ")),
              Fg(o, ti.fromRangeEnd(t))
                ? n.replace(/(&nbsp;| )(<br( \/)>)?$/, "&nbsp;")
                : n.replace(/&nbsp;(<br( \/)?>)?$/, " ")
            );
          })(o, n.getRng(), t)
    ...
    QN = (e, t) => {
      ...
      Pv(e, {
        ...
        const n = ((e, t, n) => cy(e).editor.insertContent(t, n))(
          e,
          t.content,
          o
        );
            ...
            lh(
              ...
              (t) =>
                ((t) =>
                  Kn(t, e).orThunk(() =>
                    "font" === Mt(t)
                      ? we(JN, e).bind((e) => Gt(t, e))
                      : M.none()
                  ))(t),
              (e) => vn(fn(t), e)
            ))(e, t, n.dom).or(
            ((e, t) => M.from(Qs.DOM.getStyle(t, e, !0)))(e, n.dom)
          )
        )
        .getOr(""),
    eR = ZN("font-size"),
          ...
          ((e) => {
            ...
            e.editorCommands.addCommands({
              ...
              FontName: (t, n, o) => {
                ((e, t) => {
                  const n = rR(e, t);
                  e.formatter.toggle("fontname", { value: sR(n) }),
                    e.nodeChanged();
                })(e, o);
              },
              FontSize: (t, n, o) => {
                ((e, t) => {
                  e.formatter.toggle("fontsize", { value: rR(e, t) }),
                    e.nodeChanged();
                })(e, o);
              },
              LineHeight: (t, n, o) => {
            ...
            ((e) => {
              ...
              e.editorCommands.addCommands(
                ...
                e.editorCommands.addQueryValueHandler("FontName", () =>
                  ((e) => oR(e, (t) => tR(e.getBody(), t.dom)).getOr(""))(e)
                ),
                e.editorCommands.addQueryValueHandler("FontSize", () =>
                  ((e) => oR(e, (t) => eR(e.getBody(), t.dom)).getOr(""))(e)
                ),
                  ...
                  (t
                    ...
                    : ((e) => {
                        ...
                        if (e.dom.isChildOf(r, n))
                          return Sf(r), kf(e, o), void Ef(e);
                        e.inline ||
                          (Nt.browser.isOpera() || Sf(n), e.getWin().focus()),
  ...
  const wR = (e, t) => {
      ...
      const n = kl(e);
      return n
        ? (e.eventRoot || (e.eventRoot = yR.select(n)[0]), e.eventRoot)
        : e.getBody();
    },
    xR = (e, t, n) => {
      ((e) => !e.hidden && !mR(e))(e)
        ...
        "focus" !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                (n.dom.unbind(wR(n, e), e, n.delegates[e]),
  ...
  class jR {
    constructor(e, t, n) {
        ...
        const n = {},
          ...
          r = (e, t, n) => {
            ...
            return NR(r)
              ? ((o[e] = r.value), !0)
              : (console.warn(
                  ER(`Invalid value passed for the ${e} option`, r)
                ),
                !1);
          },
          s = (e) => xe(n, e);
            ...
            const a = ((e) => m(e.processor))(s)
              ...
              i = ((e, t, n) => {
                if (!v(t)) {
                  ...
                  console.error(
                    ER(`Invalid default value passed for the "${e}" option`, o)
                  );
                }
              })(e, s.default, a);
      ...
      const l = cl(o);
      l &&
        (Zs.ScriptLoader._setReferrerPolicy(l),
      ...
      ((e) => {
        ...
        e.on("remove", () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) =>
            Xo.forElement(e, { contentCssCors: Vl(t), referrerPolicy: cl(t) }))(
            o,
            e
          )),
          Pl(e)
        ...
        s &&
          ...
          Ll(e) &&
            !No(e.getElement()) &&
            (MN.insertAfter(MN.create("input", { type: "hidden", name: t }), t),
            (e.hasHiddenInput = !0)),
    ...
    show() {
      ...
      e.hidden &&
        ...
        e.inline
          ...
          : (FR.show(e.getContainer()), FR.hide(e.id)),
        e.load(),
        e.dispatch("show"));
    }
    hide() {
    ...
    getContainer() {
      ...
      return (
        e.container ||
          (e.container = FR.get(e.editorContainer || e.id + "_parent")),
        e.container
      );
    }
    ...
    getElement() {
      return (
        this.targetElm || (this.targetElm = FR.get(this.id)), this.targetElm
      );
    }
    getWin() {
      const e = this;
  ...
  const KR = (e) => {
    ...
    GR = (e) => {
      if (e !== qR) {
        const t = Qs.DOM;
        e
          ? (t.bind(window, "resize", KR), t.bind(window, "scroll", KR))
          : (t.unbind(window, "resize", KR), t.unbind(window, "scroll", KR)),
          (qR = e);
      }
    },
    YR = (e) => {
      ...
      return (
        (WR = K(WR, (t) => e !== t)),
        QR.activeEditor === e &&
          (QR.activeEditor = WR.length > 0 ? WR[0] : null),
    ...
    QR = {
        ...
        if (e) {
          if (!m(e))
            return (
              ...
              h(t.get(o.id))
                ? null
                : (YR(o) && t.dispatch("RemoveEditor", { editor: o }),
                  0 === WR.length &&
      ...
      _setBaseUrl(e) {
        (this.baseURL = new xv(this.documentBaseURL).toAbsolute(
          e.replace(/\/+$/, "")
        )),
